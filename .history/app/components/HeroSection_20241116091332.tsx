  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-4">
        {/* Card 1 - Bio */}
        <div className="bg-gray-300 text-black-600 rounded-lg shadow-lg p-6 hover:shadow-xl transition duration-300">
        ...
        {/* Card 3 - Experience */}
        <div className="bg-gray-400 text-black-600 rounded-lg shadow-lg p-6 hover:shadow-xl transition duration-300">
