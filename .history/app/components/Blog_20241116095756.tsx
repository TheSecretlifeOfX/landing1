      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-300 rounded-lg shadow-lg overflow-hidden transform transition-transform hover:scale-105 hover:rotate-3">
            <img src="/Images/Bimage1.jpg" alt="Blog Image 1" className="w-full h-48 object-cover" />
            <div className="p-6">
          ...
          {/* Blog Post 2 */}
          <div className="bg-gray-300 rounded-lg shadow-lg overflow-hidden transform transition-transform hover:scale-105 hover:rotate-3">
            <img src="/Images/Bimage2.jpg" alt="Blog Image 2" className="w-full h-48 object-cover" />
            <div className="p-6">
          ...
          {/* Blog Post 3 */}
          <div className="bg-gray-300 rounded-lg shadow-lg overflow-hidden transform transition-transform hover:scale-105 hover:rotate-3">
            <img src="/Images/Bimage3.jpeg" alt="Blog Image 3" className="w-full h-48 object-cover" />
            <div className="p-6">
          ...
          {/* Blog Post 4 */}
          <div className="bg-gray-300 rounded-lg shadow-lg overflow-hidden transform transition-transform hover:scale-105 hover:rotate-3">
            <img src="/Images/Bimage4.png" alt="Blog Image 4" className="w-full h-48 object-cover" />
            <div className="p-6">
          ...
          {/* Blog Post 5 */}
          <div className="bg-gray-300 rounded-lg shadow-lg overflow-hidden transform transition-transform hover:scale-105 hover:rotate-3">
            <img src="/Images/Bimage5.webp" alt="Blog Image 5" className="w-full h-48 object-cover" />
            <div className="p-6">
          ...
          {/* Blog Post 6 */}
          <div className="bg-gray-300 rounded-lg shadow-lg overflow-hidden transform transition-transform hover:scale-105 hover:rotate-3">
            <img src="/Images/Bimage6.png" alt="Blog Image 6" className="w-full h-48 object-cover" />
            <div className="p-6">
