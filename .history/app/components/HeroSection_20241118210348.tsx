...
export default function HeroSection() {
  return (
    <section
      id="hero"
      className="w-full py-32 bg-white bg-opacity-80 text-gray-600 flex flex-col items-center justify-center mt-20"
    >
      <h1 className="text-5xl font-bold mb-8">About Me</h1>
      <p className="text-xl mb-12 max-w-3xl text-center">
        I am a passionate web developer who builds modern, responsive websites with Next.js and other cutting-edge technologies.
      </p>
        ...
        <div className="bio-card relative rounded-lg shadow-lg p-6 hover:shadow-xl transition duration-300 h-80">
          <div className="bg-black bg-opacity-50 rounded-lg h-full p-6 flex flex-col justify-end">
            ...
            <p className="text-lg text-white">
              I am a self-taught developer with a passion for learning and building. With a strong foundation in JavaScript and React, I enjoy turning ideas into functional and beautiful websites.
            </p>
          </div>
        </div>
