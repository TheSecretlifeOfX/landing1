...
export default function CallToAction() {
  return (
    <section id="contact" className="py-14 text-center bg-gray-600 text-white mb-20">
      ...
      <form className="max-w-3xl mx-auto bg-white p-6 rounded-lg shadow-lg">
        ...
        <div className="mb-4">
          <button type="submit" className="px-6 py-2 bg-gray-200 text-black font-semibold rounded-lg shadow-lg hover:bg-gray-400">
            SUBMIT
          </button>
        </div>
      </form>
