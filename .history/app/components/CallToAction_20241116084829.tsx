...
export default function CallToAction() {
  return (
    <section id="contact" className="py-20 text-center bg-gray-600 text-white mt-[-90] mb-20">
      ...
      <form className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-lg">
        ...
        <div className="mb-6">
          <button type="submit" className="px-8 py-3 bg-gray-200 text-black font-semibold rounded-lg shadow-lg hover:bg-gray-400">
            SUBMIT
          </button>
        </div>
      </form>
      ...
      <div className="mt-3">
        ...
        <div className="flex justify-center space-x-6 mt-2 mb-[-20]">
          <a
