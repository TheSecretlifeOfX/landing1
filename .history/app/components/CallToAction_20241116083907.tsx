...
export default function CallToAction() {
  return (
    <section id="contact" className="py-20 text-center bg-gray-600 text-white">
      ...
      <form className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-lg">
        ...
        <div className="mb-6">
          <button type="submit" className="px-8 py-3 bg-gray-200 text-white font-semibold rounded-lg shadow-lg hover:bg-blue-700">
            Submit
          </button>
        </div>
      </form>
