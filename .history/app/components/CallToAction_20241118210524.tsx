...
export default function CallToAction() {
  return (
    <section id="contact" className="py-3 px-2 mt-10 text-center bg-gray-200 text-black mb-5 rounded-lg">
      <h2 className="text-3xl font-bold mb-4">Ready to get started?</h2>
      <p className="mb-4">We would love to hear about your project! Please provide the details, and we will get back to you shortly.</p>
      ...
      <div className="mt-4">
        ...
        <div className="flex justify-center space-x-6 mt-2">
          <a
            href="https://www.instagram.com/thesecretlifeof_x_/?hl=en"
            target="_blank"
          ...
          <a
            href="https://x.com/D_FirstUnknown"
            target="_blank"
            rel="noopener noreferrer"
            className="text-white hover:text-gray-600 transition-colors"
            aria-label="Twitter"
          ...
          <a
            href="https://www.linkedin.com/in/wisdom-val/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-white hover:text-gray-600 transition-colors"
            aria-label="LinkedIn"
